        ...
        <form onSubmit={addMod}>
            <Row>
                <Col>
                    ...
                    <Form.Control type="text" placeholder="" onChange={e => setMod(e.target.value)} value={mod}/>
                </Col>
                <Col>
                    <Form.Label>Grade</Form.Label>
                    <Form.Control as='select' defaultValue='' onChange={e => setGrade(e.target.value)} value={grade}>
